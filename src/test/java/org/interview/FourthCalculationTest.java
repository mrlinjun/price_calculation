...
import org.interview.calculate.impl.FourthPriceCalService;
 ...
 *
 */
public class FourthCalculationTest {

    private FourthPriceCalService priceCalService = FourthPriceCalService.getInstance();

    /**
     * 输入错误的斤数入参个数，按期望抛出WeightNumException异常
     */
    @Test(expected = WeightNumException.class)
    public void testNo4WrongWeightNum() {
    ...
    public void testNo4WrongWeightFormat1() {
     ...
     */
    @Test(expected = WeightFormatException.class)
    public void testNo4WrongWeightFormat2() {
